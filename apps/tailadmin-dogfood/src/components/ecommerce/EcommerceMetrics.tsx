        ...
        <div className="flex items-end justify-between mt-5">
          <div>
            <span
              ...
              className="text-sm font-normal text-green-600 xl:bg-white xl:text-sm xl:font-semibold xl:text-gray-900 dark:text-gray-400"
            >
              Customers
            </span>
            <h4
              data-nuvio-id="metric.customers.value"
              className="mt-2 text-sm font-normal text-green-600 xl:text-sm xl:font-normal xl:hidden xl:text-green-600 dark:text-white/90"
            >
              3,782 00
            </h4>
          </div>
