...
**After instrumentation:** user runs `npm run dev`, Edit on, Preview Changes, Apply to Code.

If Vite or shell wiring is missing, see `nuvio/SETUP_TODO.md` or run `pnpm dlx @nuvio/cli@0.5.3 init`.
