...
const REASON_MAP: ReadonlyArray<{
  ...
  },
  {
    ...
    message: {
      sentence: "rte couldn't find this element in source — click it again or refresh the page.",
      suggestedAction: "addId",
    },
  },
  {
  ...
  },
  {
    ...
    message: {
      sentence:
        "This class uses utilities rte can't edit yet — simplify the styles on this element or edit in your code editor.",
      suggestedAction: "useHandoff",
      handoffStep:
        "Remove or simplify responsive/dark Tailwind classes on this element so rte can edit padding, radius, and shadow.",
    },
  },
];
...
export function getPlainPatchHandoffStep(message: string | null | undefined): string {
  if (!message) {
    return "Review this element in source and fix the styles or rte ids.";
  }
